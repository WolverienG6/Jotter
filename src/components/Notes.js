...
const Notes = (props) => {
    ...
    const refClose = useRef(null); //useRef hook is used to refer an element, here we are using for Modal
    const [note,setNote] = useState({id: "",etitle: "",edescription: "",etag: ""});

    const updateNote = (currentNote) => {
        ref.current.click();//if modal is hiding then it will show it or vice versa
                        ...
                        <div className="modal-body">
                            <form className="my-3">
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="etag" name="etag" onChange={handleChange} value={note.etag} minLength={5} required/>
                                </div>
                            </form>
                        </div>
